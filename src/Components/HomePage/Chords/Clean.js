...
class Clean extends Component{
    ...
    Cleans=()=> {
          ...
          Transport.cancel()
          Transport.schedule(this.chord_1, 0)
          Transport.schedule(() => '0:0:1')
          Transport.schedule(this.chord_2, '0:0:2')
          Transport.schedule(() => '0:0:3')
          Transport.schedule(this.chord_3, '0:1')
          Transport.schedule(() => '0:1:1')
          Transport.schedule(this.chord_4, '0:1:2')
          Transport.schedule(() => '0:1:3')
          Transport.schedule(this.chord_1, '0:2')
          Transport.schedule(() => '0:2:1')
          Transport.schedule(this.chord_2, '0:2:2')
          Transport.schedule(() => '0:2:3')
          Transport.schedule(this.chord_3, '0:3')
          Transport.schedule(() => '0:3:1')
          Transport.schedule(this.chord_4, '0:3:2')
          Transport.schedule(() => '0:3:3')
    ...
    render() {
        ...
        return(
            <div className={'chord_files'}>
              {/* <button onClick = {this.clickHandlerBTN}>{!this.state.p ? 'Click Me!!!' : 'Dont Click Me!!!' }</button> */}
                <div className={'chords'}>
              {  !this.state.isLoaded? <Spinner />:null}
                    <Chord_01 sampler={this.chord_1} opened = {this.stopWhenOpened}/>
                    <Chord_02 sampler={this.chord_2} opened = {this.stopWhenOpened}/>
                    <Chord_03 sampler={this.chord_3} opened = {this.stopWhenOpened}/>
                    <Chord_04 sampler={this.chord_4} opened = {this.stopWhenOpened}/>
                </div>
                <div className={'play_and_range_all'}>
                    <div className={'play_and_range'}>
                        ...
                        <div className={'range'}>
                            <p>BPM:{this.state.tempo*7}</p>
                            <input type="range"  min="9" max="25" onChange={this.updateTemp} defaultValue={this.state.tempo} />
                        </div>
                    </div>
                </div>
                <div>
...
export default connect(mapState, mapDispatch)(Clean);