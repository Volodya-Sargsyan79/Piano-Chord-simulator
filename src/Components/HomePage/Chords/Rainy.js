...
class Rainy extends Component{
    ...
    Rainys=()=>{
        ...
        Transport.schedule(this.chord_01, '0:1')
        Transport.schedule(() => '0:1:1')
        Transport.schedule(this.chord_01, '0:1:2')
        Transport.schedule(() => '0:1:3')
        Transport.schedule(this.chord_02, '0:2')
        Transport.schedule(() => '0:2:1')
        Transport.schedule(this.chord_02, '0:3')
        Transport.schedule(() => '0:3:1')
        Transport.schedule(this.chord_02, '0:3:2')
        Transport.schedule(() => '0:3:3')
        Transport.schedule(this.chord_03, '0:4')
        Transport.schedule(() => '0:4:1')
        Transport.schedule(this.chord_03, '0:5')
        Transport.schedule(() => '0:5:1')
        Transport.schedule(this.chord_03, '0:5:2')
        Transport.schedule(() => '0:5:3')
        Transport.schedule(this.chord_04, '0:6')
        Transport.schedule(() => '0:6:1')
        Transport.schedule(this.chord_04, '0:7')
        Transport.schedule(() => '0:7:1')
        Transport.schedule(this.chord_04, '0:7:2')
        Transport.schedule(() => '0:7:3')
      ...
      chord_01=(time)=>{
        ...
        console.log(this.props.keyColor.key_01)
        console.log(time)
        this.sampler.triggerAttackRelease(chordNotes, "5n", time)
              ...
              {  !this.state.isLoaded? <Spinner />:null}
                ...
                <div className={'play_and_range_all'}>
                    <div className={'play_and_range'}>
                        ...
                        <div className={'range'}>
                            <p>BPM:{this.state.tempo*1.5}</p>
                            <input type="range"  min="40" max="120" onChange={this.updateTemp} defaultValue={this.state.tempo} />
                        </div>
                    </div>
                </div>
                <div>
...
export default connect(mapState, mapDispatch)(Rainy);